...
## Sentiment Analyzer
- Location: `src/components/SentimentAnalyzer.jsx`
- Route: `/sentiment-analyzer`

Features:
- Upload CSV or Excel files, select a text column, and run Gemini-powered sentiment analysis in batches.
- Configure output column names, adjust prompts or custom rules, normalize positive/neutral/negative scores, and export enriched rows to CSV or Excel.
