    ...
    <main className='min-h-screen bg-gray-50 py-6'>
      <div className='max-w-6xl mx-auto px-4 space-y-6'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
          ...
          <section className='lg:col-span-2 bg-white border-2 border-black rounded-xl p-4 shadow-md flex flex-col gap-3'>
            ...
            <div className='overflow-auto border-2 border-dashed border-black rounded-lg'>
              {data.length > 0 ? (
