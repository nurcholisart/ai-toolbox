...
const promptOptimizationSystemInstruction = [
  'You are a Principal Prompt Engineer specializing in optimizing prompts for the GPT-5 model. Your task is to revise and refine the provided prompt to achieve maximum clarity, efficiency, and compliance.',
  '',
...
const promptTestSystemInstruction =
  'You are evaluating a prompt. Follow the prompt instructions exactly when responding to the provided sample input.'
    ...
    try {
      ...
      const payload = {
        systemInstruction: {
          ...
          parts: [
            {
              text: promptTestSystemInstruction,
            },
          ],
        },
        contents: [
